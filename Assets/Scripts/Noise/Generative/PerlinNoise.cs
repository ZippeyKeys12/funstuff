...
namespace ZNoise
{
    ...
    public class PerlinNoise : Generator
    {
        ...
        public override Sample1D Get(float x, float frequency)
        {
            ...
            x -= Mathf.Floor(x);
            var u = interp(x);
            return Mathf.Lerp(Grad(perm[X], x), Grad(perm[X + 1], x - 1), u) * 2;
        }
        ...
        public override Sample2D Get(float x, float y, float frequency)
        {
            ...
            return Mathf.Lerp(Mathf.Lerp(Grad(perm[A], x, y), Grad(perm[B], x - 1, y), u),
        ...
        public override Sample3D Get(float x, float y, float z, float frequency)
        {
            ...
            return Mathf.Lerp(Mathf.Lerp(Mathf.Lerp(Grad(perm[AA], x, y, z), Grad(perm[BA], x - 1, y, z), u),
