...
namespace ZNoise
{
    ...
    {
        public abstract Sample1D Get(float x, float frequency);
        public abstract Sample2D Get(float x, float y, float frequency);
        public abstract Sample3D Get(float x, float y, float z, float frequency);
